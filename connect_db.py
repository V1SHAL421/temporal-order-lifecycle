...
cur.execute("CREATE TABLE IF NOT EXISTS orders (id TEXT PRIMARY KEY, state TEXT, address_json TEXT, items_json TEXT, created_at TIMESTAMP, updated_at TIMESTAMP)")
